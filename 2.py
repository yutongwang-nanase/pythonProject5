...
paragraph1 = html.Div([
    html.H1('欢迎来到我的网页！'),
    html.P('这是我仿照matbench创建的一个页面，旨在帮助您更好地理解材料科学和计算材料学。'),
    html.P('通过这个页面，您可以了解到各种材料属性的数据集和模型，以及它们如何被用于材料设计和发现。'),
])

# 第二个段落
paragraph2 = html.Div([
    html.P('页面的设计和功能灵感来自于matbench项目，它是一个由材料科学家和计算机科学家合作创建的开放数据集和基准测试平台。'),
    html.P('与matbench不同的是，我的页面重点放在对材料科学初学者友好的解释和展示上，同时也提供了一些进阶的内容和资源，以满足更高级的用户需求。'),
])
...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Br(),
    ], style={'position': 'fixed', 'width': '20%', 'left': '100px', 'top': '50px'}),
...
if __name__ == '__main__':
    app.run_server(debug=True, host='127.0.0.1.js', port=8082)
